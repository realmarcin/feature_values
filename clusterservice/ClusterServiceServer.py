...
async_run_methods = {}
async_check_methods = {}
async_run_methods['ClusterService.cluster_float_rows_scikit_kmeans_async'] = ['ClusterService', 'cluster_float_rows_scikit_kmeans']
async_check_methods['ClusterService.cluster_float_rows_scikit_kmeans_check'] = ['ClusterService', 'cluster_float_rows_scikit_kmeans']
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_ClusterService.cluster_float_rows_scikit_kmeans,
                             ...
                             types=[dict])
        self.method_authentication['ClusterService.cluster_float_rows_scikit_kmeans'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "ClusterService but no authentication header was passed"
                            raise err
