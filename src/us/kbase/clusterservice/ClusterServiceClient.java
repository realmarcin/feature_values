...
public class ClusterServiceClient {
     ...
     */
    public ClusterServiceClient(URL url) {
     ...
     * validity.
     */
    public ClusterServiceClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public ClusterServiceClient(URL url, String user, String password) throws UnauthorizedException, IOException {
    ...
    public ClusterResults clusterFloatRowsScikitKmeans(ClusterFloatRowsScikitKmeansParams params) throws IOException, JsonClientException {
        ...
        List<ClusterResults> res = caller.jsonrpcCall("ClusterService.cluster_float_rows_scikit_kmeans", args, retType, true, true);
        return res.get(0);
    }
}
